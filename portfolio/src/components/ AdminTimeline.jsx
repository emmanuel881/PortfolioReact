...
const AdminTimeline = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-white p-6">
            <div className="max-w-3xl mx-auto bg-gray-800 shadow-lg rounded-xl p-6">
                <h2 className="text-2xl font-semibold text-center mb-4">📜 Manage Timeline</h2>
            ...
            {/* Timeline List */}
            <div className="max-w-3xl mx-auto mt-6 bg-gray-800 shadow-lg rounded-xl p-6">
                <h3 className="text-xl font-semibold text-center mb-4">📌 Timeline Entries</h3>
                {timelines.length === 0 ? (
                    <p className="text-gray-400 text-center">No timeline entries yet.</p>
                ) : (
                        ...
                        {timelines.map((timeline) => (
                            <li key={timeline._id} className="bg-gray-700 p-4 rounded-lg">
                                ...
                                <p className="text-sm text-gray-400">
                                    {new Date(timeline.from).toLocaleDateString()} -{" "}
                                    {timeline.to ? new Date(timeline.to).toLocaleDateString() : "Present"}
                                </p>
